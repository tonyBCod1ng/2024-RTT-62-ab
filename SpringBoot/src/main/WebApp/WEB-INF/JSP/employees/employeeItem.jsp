...
<div class="row justify-content-center text-center">
    ...
    <div class="col col-1">
        <a class="btn btn-warning" href="http://localhost:8080/employees/edit/${employee.id}">Edit</a>
    </div>
</div>

<div class="row justify-content-center cols-2">
    <div class="col-4">
        <img style="object-fit: cover ;height: 250px ;width: 250px; border-radius: 200px" src="${employee.profileImageUrl}"/>
    </div>
    <div class="col col-4">
        <table class="table">
            <tr>
