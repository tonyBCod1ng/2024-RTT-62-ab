...
public class ArrayAssignment {
    ...
    //region -Task 2: Write a program that returns the middle element in an array.
    ...
    //region -Task 3: Write a program that creates an array of String type and
    ...
    //region -Write a program that creates an integer array with 5 elements (i.e., numbers).
    ...
    //region -Write a program where you create an integer array with a length of 5.
    ...
    //region - Write a program where you create an integer array of 5 numbers.
    ...
    //region -Write a program where you create an array of 5 elements.
    ...
    //region -Write a program that creates a String array of 5 elements
    ...
    //region -Write a program to sort the following int array in ascending order: {4, 2, 9, 13, 1, 0}.
